...
const EXERCISE_SUGGESTIONS: Record<string, string[]> = {
  ...
  Pull: ["Pull-Ups", "Wide Grip Pull-Up", "Archer Pull-Up", "Chin-Ups", "Australian Pull-Ups", "Muscle-Up", "Muscle-Up Negative", "Rows", "Cable Rows", "Lat Pulldown", "Face Pulls", "Deadlift", "Hammer Curls", "Machine Bicep Curl", "Barbell Curl", "EZ Bar Curl", "Preacher Curl"],
